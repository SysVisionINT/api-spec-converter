            ...
            if (HTTP_METHODS.indexOf(method) >= 0) {
                ...
                if (commonParameters) {
                    operation.parameters = operation.parameters
                                         ? operation.parameters.concat(commonParameters)
                                         : commonParameters.slice();
                }
